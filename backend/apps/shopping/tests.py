...
class ShoppingAdminTests(TestCase):
    """Tests for shopping admin registration."""

    def test_shopping_models_are_registered_in_admin(self) -> None:
        """Shopping models should be available in Django admin."""
        registered_models = (PantryItem, ShoppingList, ShoppingListItem)
